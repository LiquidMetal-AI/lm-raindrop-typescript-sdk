...
export interface ChatInteractResponse {
  /**
...
export interface ChatInteractParams {
  /**
...
export declare namespace Chat {
  export { type ChatInteractResponse as ChatInteractResponse, type ChatInteractParams as ChatInteractParams };
}
