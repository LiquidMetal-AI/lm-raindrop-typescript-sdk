...
import { AbstractPage, type PageNumberResultsParams, PageNumberResultsResponse } from './core/pagination';
...
export declare namespace Raindrop {
  ...
  export import PageNumberResults = Pagination.PageNumberResults;
  export {
    type PageNumberResultsParams as PageNumberResultsParams,
    type PageNumberResultsResponse as PageNumberResultsResponse,
  };
