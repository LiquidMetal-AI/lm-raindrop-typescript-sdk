...
[![NPM version](https://img.shields.io/npm/v/@liquidmetal/lm-raindrop.svg)](https://npmjs.org/package/@liquidmetal/lm-raindrop) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/@liquidmetal/lm-raindrop)
...
```sh
npm install @liquidmetal/lm-raindrop
```
...
```ts
import Raindrop from 'npm:@liquidmetal/lm-raindrop';
