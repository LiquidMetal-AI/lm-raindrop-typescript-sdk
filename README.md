...
await client.query.documentQuery({ bucket_location: { bucket: { name: 'my-smartbucket' } }, input: 'What are the key points in this document?', object_id: 'document.pdf', request_id: '<YOUR-REQUEST-ID>' }, {
  maxRetries: 5,
});
```
