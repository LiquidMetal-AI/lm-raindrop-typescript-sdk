...
describe('instantiate client', () => {
  ...
  describe('baseUrl', () => {
    ...
    test('in request options overridden by client options', () => {
      const client = new Raindrop({ apiKey: 'My API Key', baseURL: 'http://localhost:5000/client' });
      expect(client.buildURL('/foo', null, 'http://localhost:5000/option')).toEqual(
    ...
    test('in request options overridden by env variable', () => {
      process.env['RAINDROP_BASE_URL'] = 'http://localhost:5000/env';
      const client = new Raindrop({ apiKey: 'My API Key' });
      expect(client.buildURL('/foo', null, 'http://localhost:5000/option')).toEqual(
  ...
  describe('withOptions', () => {
    test('creates a new client with overridden options', async () => {
      const client = new Raindrop({ baseURL: 'http://localhost:5000/', maxRetries: 3, apiKey: 'My API Key' });
    ...
    test('respects runtime property changes when creating new client', () => {
      const client = new Raindrop({ baseURL: 'http://localhost:5000/', timeout: 1000, apiKey: 'My API Key' });
